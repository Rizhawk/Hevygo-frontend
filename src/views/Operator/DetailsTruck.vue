...
export default {
  ...
  data: () => {
    return {
      ...
      types: [
        "6 Tyre Truck",
        "10 Tyre Multy Axle Truck",
        "12 Tyre Single Chassis Rigid Truck",
        "14 Tyre Single Chassis Rigid Truck ",
        "14 Tyre Semi Trailer",
        "18 Tyre Semi Trailer",
        "22 Tyre Semi Trailer",
      ],
      model: "",
      capacity: "",
      snackbar: false,
